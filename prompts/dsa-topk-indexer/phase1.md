# DSA TopK Indexer Phase 1 Prompt
...
Research existing implementations and produce the first correct B200 implementation. Focus on understanding the data layout, correctness contract, baseline behavior, workload shape distribution, and feasible implementation strategies. Performance matters, but correctness and a clean baseline design are the priority for this phase.

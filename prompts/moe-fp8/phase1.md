...
Research existing CUDA and CuTe MoE implementations and produce the first correct B200 implementation. Focus on understanding the FP8 block-scale layout, DeepSeek-V3 no-aux routing, local expert filtering, routing-weight normalization, and a simple correct CUDA implementation strategy. Performance matters, but correctness and a clean baseline design are the priority for this phase.

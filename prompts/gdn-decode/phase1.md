...
Research existing GDN decode implementations and produce the first correct B200 implementation. Focus on understanding the k-last state layout, grouped-value head mapping, numerical requirements for the state update, and a simple correct implementation strategy. Performance matters, but correctness and a clean baseline design are the priority for this phase.

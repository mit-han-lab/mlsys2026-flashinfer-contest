...
Start from the best correct Phase 2 implementation and run another Phase 2-style exploration pass. Use NCU profiling, KernelWiki, and public documentation to identify additional plausible optimization directions, then explore them systematically.
